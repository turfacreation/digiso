...
var Swiper = (function () {
	...
	function N(e) {
		...
		if (void 0 === i.isScrolling) {
			...
			:	m * m + h * h >= 25 &&
				...
				(i.isScrolling =
					t.isHorizontal() ? e > r.touchAngle : 90 - e > r.touchAngle));
		}
		if (
		...
		let f = t.isHorizontal() ? m : h,
			g =
				t.isHorizontal() ? a.currentX - a.previousX : a.currentY - a.previousY;
		(r.oneWayMovement &&
		...
		if (
			...
			if (!i.allowThresholdMove)
				return (
					...
					void (a.diff =
						t.isHorizontal() ? a.currentX - a.startX : a.currentY - a.startY)
				);
		}
		r.followFinger &&
			!r.cssMode &&
	...
	var W = {
		...
		loopFix: function (e = {}) {
			...
			(
				u.length < S + T ||
				("cards" === p.params.effect && u.length < S + 2 * T)
			) ?
				c(
		...
		translateTo: function (e = 0, t = this.params.speed, s = !0, i = !0, r) {
			...
			return (
				0 === t ?
					(a.setTransition(0),
					a.setTranslate(c),
					s && (a.emit("beforeTransitionStart", t, r), a.emit("transitionEnd")))
				:	(a.setTransition(t),
					a.setTranslate(c),
					s &&
				...
				if (((p = !1), (m = !1), h.push(t), !(h.length < 2))) {
					if (((p = !0), (g.scaleStart = E()), !g.slideEl)) {
						...
						if (
							...
							(g.imageEl = r ?? void 0),
							(g.imageWrapEl =
								r ? (f(r, `.${s.containerClass}`)[0] ?? void 0) : void 0),
							!g.imageWrapEl)
						)
			...
			function $(t) {
				...
				if (!g.slideEl) {
					...
					(s &&
						...
						(g.imageEl = s ?? void 0),
						(g.imageWrapEl =
							s ? (f(s, `.${i.containerClass}`)[0] ?? void 0) : void 0));
				}
			...
			function k() {
				...
				if (!g.slideEl) {
					...
					(i &&
						...
						(g.imageEl = i ?? void 0),
						(g.imageWrapEl =
							i ? (f(i, `.${s.containerClass}`)[0] ?? void 0) : void 0));
				}
				g.imageEl &&
					g.imageWrapEl &&
					g.slideEl &&
		...
		({ swiper: e, extendParams: t, on: s }) => {
			...
			const x = (e, t, s) => {
				...
				A = () => {
					...
					L();
					const o =
							e.navigation ? e.navigation : { nextEl: void 0, prevEl: void 0 },
						d = w(o.nextEl),
						c = w(o.prevEl);
					if (
